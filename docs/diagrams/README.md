...
| DGM-14 | Personal Mode pairing | [spec](specifications/dgm-14-personal-mode-pairing.md) | [mmd](source/dgm-14-personal-mode-pairing.mmd) | `personal-mode-pairing.svg` | pending |
...
| DGM-16 | Backup creation flow | [spec](specifications/dgm-16-backup-create-flow.md) | [mmd](source/dgm-16-backup-create-flow.mmd) | `backup-create-flow.svg` | pending |
...
| DGM-19 | CSRF double-submit | [spec](specifications/dgm-19-csrf-double-submit.md) | [mmd](source/dgm-19-csrf-double-submit.mmd) | `csrf-double-submit.svg` | pending |

19 diagrams. DGM-01–12 are the networking batch (DGM-12 is reused across two sections). DGM-13–19 are the core-feature batch (DGM-13/15/17/18 from K.3B-1; DGM-14/16/19 from K.3B-2).
